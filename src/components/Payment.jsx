...
const Payment = () => {
  return (
    <section className="container mx-auto px-2 sm:px-8">
      ...
      <div className="flex text-sm gap-6">
        <button className="h-12 w-40 border border-gray-950 rounded-md">Back</button>
        <button className="h-12 w-40 bg-[#000000] rounded-md text-white">Pay</button>
      </div>
    </section>
  )
}
